...
#     plt.figure(figsize=(10,10))
    ...
    plt.savefig("confusion_matrix_gama_ensemble(advance augmentation and normal- part2) fold number: "+str(fold)+ ".png")
    plt.show()
...
def ensemble_sugeno(fold,X_test,X_val,y_test,y_val,model1,model2,model3):
    ...
    plt.ylabel('Actual Values')
    plt.xlabel('Predicted Values')
    plt.savefig("confusion_matrix_sugeno_based_ensemble(advance and normal augmentation part2)"+str(fold)+".png")
    plt.show()
...
#     plt.figure(figsize=(3,3))
    ...
    plt.ylabel('Actual Values')
    plt.xlabel('Predicted Values')
    plt.savefig("confusion_matrix_rank_based_ensemble(advance and normal augmentation part2)"+str(fold)+".png")
    plt.show()
...
if __name__ == '__main__':  #straight away go to this
    ...
    # Split the data into training and validation sets
        ...
        output_nums = 5  # Number of Class for Classification Problems, always '1' for Regression Problems
        reduction_ratio = 8
        #
        ...
        filename ='SEInceptionV4_model_'+str(model_counter)+'.sav'
                                                                  
        numpy_path='SEInceptionV4_model_history'+'.npy'
    ...
    df.to_csv("SEInceptionV4_model_k_fold_results_with_advance_augmentation_and normal.csv")
