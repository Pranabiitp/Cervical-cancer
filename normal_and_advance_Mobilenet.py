...
if __name__ == '__main__':  #straight away go to this
    ...
    # Split the data into training and validation sets
        ...
        filename ='MobileNet_model_'+str(model_counter)+'.sav'
                                                                  
        numpy_path='MobileNet_model_history'+'.npy'
    ...
    df.to_csv("MobileNet_model_k_fold_results_with_advance_augmentation_and normal.csv")
